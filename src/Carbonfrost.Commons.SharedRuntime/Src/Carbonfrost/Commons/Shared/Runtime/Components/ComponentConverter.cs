...
namespace Carbonfrost.Commons.Shared.Runtime.Components {
    ...
    public sealed class ComponentConverter : TypeConverter {
        ...
        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) {
            ...
            if (sourceType.Equals(typeof(string))) {
                return true;
            } else if (sourceType.Equals(typeof(Uri))) {
                return true;
            } else {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            ...
            if (s != null)
                return Component.Parse(s);

            Uri u = value as Uri;
            if (u != null)
                return Component.FromUri(u);
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) {
            if (destinationType == null) { throw new ArgumentNullException("destinationType"); } // $NON-NLS-1
            Component vr = value as Component;
            if (vr == null) {
            ...
            if (destinationType.Equals(typeof(string))) {
                return vr.ToString();
            } else if (destinationType.Equals(typeof(Uri))) {
                return vr.ToUri();
            } else {
                throw base.GetConvertToException(value, destinationType);
            }
