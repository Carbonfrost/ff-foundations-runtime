...
namespace Carbonfrost.Commons.Shared.Runtime {
    ...
    public abstract class ProviderRegistration : IProviderRegistration {

        public static readonly IProviderRegistration Default
            = new DefaultProviderRegistration();

        public static readonly IProviderRegistration Explicit
            = new ExplicitProviderRegistration();

        public static readonly IProviderRegistration None
            = new NullProviderRegistration();
        ...
        sealed class NullProviderRegistration : ProviderRegistration {}
    }
}
